...
public class DeleteEventListener extends StandardEventListener {

    protected EventResult fire(final Event event) throws SystemException, ApplicationException {
        final DeleteEvent deleteEvent = (DeleteEvent) event;
        final String userDataId = deleteEvent.getUserDataId();
