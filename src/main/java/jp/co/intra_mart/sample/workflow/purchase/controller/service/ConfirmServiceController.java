...
/**
 * サンプル用確認画面を表示するためのサービスコントローラー
 * @author INTRAMART
 * @version 8.0.6
 * @since 7.2
 */
public class ConfirmServiceController extends ServiceControllerAdapter {

    public ConfirmServiceController() {
        super();
    }
    ...
    public ServiceResult service() throws SystemException, ApplicationException {
        ...
        final ConfirmServiceResult serviceResult = new ConfirmServiceResult();
