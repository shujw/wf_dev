...
/**
 * サンプル用詳細画面を表示するためのサービスコントローラー
 * @author INTRAMART
 * @version 8.0.6
 * @since 7.2
 */
public class DetailServiceController extends ServiceControllerAdapter {
    ...
    public ServiceResult service() throws SystemException, ApplicationException {
        ...
        final DetailServiceResult serviceResult = new DetailServiceResult();
        ...
        serviceResult.setImwShortCutFlag(request.getParameter("imwShortCutFlag"));
