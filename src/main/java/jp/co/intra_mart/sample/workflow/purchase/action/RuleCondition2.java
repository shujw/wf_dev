 ...
 */
public class RuleCondition2 extends RuleConditionEventListener {

    public RuleCondition2() {
        super();
    }
    ...
    public boolean execute(final RuleConditionParameter parameter) throws Exception {
        System.out.println("----- RuleCondition2 - execute -----");
        ...
        if (eventResult.getModelObject() != null){
            ...
            if (Integer.valueOf(modelObject.getItemTotal()).intValue() >= minimum
                    && Integer.valueOf(modelObject.getItemTotal()).intValue() < maximum) {
                result = true;
            }
        }
