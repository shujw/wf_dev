...
<table border="0">
	...
	<tr>
		...
		<table class="table_border_line">
			<tr>
				<td><imchart:chart displayType="3D" style="pie" data="<%=pieGraphInfo %>" imageHeight="330" imageWidth="270"></imchart:chart></td>
			</tr>
		</table>
		</td>
		<td></td>
		...
		<table class="table_border_line">
			<tr>
				<td><imchart:chart displayType="3D" style="bar" data="<%=barGraphInfo %>" imageHeight="330" imageWidth="270"></imchart:chart>
				</td>
			</tr>
		</table>
		</td>
		...
		<table class="table_border_line">
			<tr>
				<td><imchart:chart displayType="3D" style="bar" data="<%=stackedBarInfo %>" imageHeight="330" imageWidth="270"></imchart:chart></td>
			</tr>
		</table>
		</td>
	</tr>
	...
	<tr>
		...
		<table class="table_border_line">
			<tr>
				<td><imchart:chart displayType="3D" style="bar" data="<%=persentageBarInfo %>" imageHeight="330" imageWidth="270"></imchart:chart>
				</td>
			</tr>
		</table>
		</td>
		...
		<table class="table_border_line">
			<tr>
				<td><imchart:chart displayType="3D" style="line" data="<%=lineGraphInfo %>" imageHeight="330" imageWidth="270"></imchart:chart></td>
			</tr>
		</table>
		</td>
		<td></td>
		...
		<table class="table_border_line">
			<tr>
				<td><imchart:chart displayType="3D" style="radar" data="<%=radarGraphInfo %>" imageHeight="330" imageWidth="270"></imchart:chart>
				</td>
			</tr>
		</table>
		</td>
	...
	<tr>
		...
		<table class="table_border_line">
			<tr>
				<td><imchart:chart displayType="3D" style="portFolio"
					data="<%=portFolioInfo %>" imageHeight="330" imageWidth="270"></imchart:chart></td>
			</tr>
		</table>
		</td>
		<td></td>
		...
		<table class="table_border_line">
			<tr>
				<td><imchart:chart displayType="3D" style="combined" data="<%=barGraphInfo %>"
		...
		<table class="table_border_line">
			<tr>
				<td><imchart:chart displayType="3D" style="bar" data="<%=barInfo %>"
					subData="<%=lineInfo %>" imageHeight="330" imageWidth="270"></imchart:chart></td>
			</tr>
		</table>
		</td>
		<td></td>
