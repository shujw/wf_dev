...
<div data-role="page" id="imw-sp-sample-approve" data-theme="a">
  ...
  <div data-role="content">
    ...
    <ul data-role="listview" class="wrap">
      <li>
        ...
        <div style="font-size:16px;padding-left:24px;text-shadow:0.5px 0.5px 0.5px #000;">
      ...
      <li data-role="fieldcontain">
        <fieldset>
          <div><button type="button" id="openPage" data-theme="b"><%=bean.getMessage("SAMPLE.IMW.CAP.005")%></button></div>
        </fieldset>
      </li>
    </ul>
  </div>
