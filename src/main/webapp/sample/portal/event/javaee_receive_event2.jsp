...
%>
<h3 style="color:#000; border-bottom: 1px solid green;">JavaEE Framework Portlet <br> 【イベント受信２】</h3>
<p align="center" style="font-size:16pt; font-weight:bold; color:#CC6347">
	<%= message %>
</p><br/>
